        ...
        <div style={{ width: isOpen ? "200px" : "70px" }} className={`sidebar`}>
          ...
          <div className="bottomSection">
            ...
            {user?.userType === "admin" ? (
             ...
             {user?.userType === "admin" ? (
              <Link className="link" activeclassname="active" to={"/list"}>
            ...
            {/* {user?.userType === "admin" ? (
              <Link className="link" activeclassname="active" to={"/docterList"}>
...
{user?.userType === "admin" ? (
              <Link className="link" activeclassname="active" to={"/viewnurse"}>
                <div className="icon">
                  <GiNurseFemale className="mainIcon" />
                </div>
                <div
